...
class Restormer(nn.Module):
    def __init__(self, 
        ...
        self.bm_down = Downsample(1)

    def forward(self, inp_img):
        blur_matrix = self.generate_bm(inp_img)

        inp_enc_level1 = self.patch_embed(inp_img)
        inp_enc_bm_level1 = blur_matrix
        out_enc_level1, _ = self.encoder_level1(inp_enc_level1, inp_enc_bm_level1)
        
        inp_enc_level2 = self.down1_2(out_enc_level1)
        inp_enc_bm_level2 = self.bm_down(inp_enc_bm_level1)
        out_enc_level2, _ = self.encoder_level2(inp_enc_level2, inp_enc_bm_level2)

        inp_enc_level3 = self.down2_3(out_enc_level2)
        inp_enc_bm_level3 = self.bm_down(inp_enc_bm_level2)
        out_enc_level3, _ = self.encoder_level3(inp_enc_level3, inp_enc_bm_level3)

        inp_enc_level4 = self.down3_4(out_enc_level3)
        inp_enc_bm_level4 = self.bm_down(inp_enc_bm_level3)
        latent, _ = self.latent(inp_enc_level4, inp_enc_bm_level4)
                        
        inp_dec_level3 = self.up4_3(latent)
        inp_dec_level3 = torch.cat([inp_dec_level3, out_enc_level3], 1)
        inp_dec_bm_level3 = torch.cat([inp_enc_bm_level3, inp_enc_bm_level3], 1)
        inp_dec_level3 = self.reduce_chan_level3(inp_dec_level3)
        out_dec_level3, _ = self.decoder_level3(inp_dec_level3, inp_dec_bm_level3)

        inp_dec_level2 = self.up3_2(out_dec_level3)
        inp_dec_level2 = torch.cat([inp_dec_level2, out_enc_level2], 1)
        inp_dec_bm_level2 = torch.cat([inp_enc_bm_level2, inp_enc_bm_level2], 1)
        inp_dec_level2 = self.reduce_chan_level2(inp_dec_level2)
        out_dec_level2, _ = self.decoder_level2(inp_dec_level2, inp_dec_bm_level2)

        inp_dec_level1 = self.up2_1(out_dec_level2)
        inp_dec_level1 = torch.cat([inp_dec_level1, out_enc_level1], 1)
        inp_dec_bm_level1 = torch.cat([inp_enc_bm_level1, inp_enc_bm_level1], 1)
        out_dec_level1, _ = self.decoder_level1(inp_dec_level1, inp_dec_bm_level1)
        
        out_dec_level1, _ = self.refinement(out_dec_level1, inp_dec_bm_level1)
